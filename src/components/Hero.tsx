...
const Hero = () => {
  ...
  return (
    <section className="pt-28 pb-20 md:pt-36 md:pb-32 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-64 h-64 bg-red-500/20 rounded-full blur-3xl floating"></div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="h-8 md:h-12 mb-8">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-mono text-gradient-orange">
              {typedText}<span className={`inline-block w-1 h-5 md:h-6 bg-red-400 ml-1 glow-orange ${isTyping ? 'animate-pulse' : 'opacity-0'}`}></span>
            </h2>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild size="lg" className="px-8 glow-orange-strong hover:glow-orange transition-all duration-300 bg-gradient-to-r from-red-500 to-blue-600 hover:from-red-600 hover:to-blue-700">
              <a href="#projects">View My Work</a>
            </Button>
            <Button asChild size="lg" variant="outline" className="px-8 border-glow hover:bg-red-500/10 transition-all duration-300 border-red-400 text-red-400">
